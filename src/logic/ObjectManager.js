...
export default class ObjectManager {
     ...
     * @param {number} xPos 
     * @param {number} yPos 
     * @param {number} s - Scale of the Entity
     * @returns {GameObject[][]}
     */
     ...
     * @param {number} sM 
     * @param {number} indx 
     * @param {boolean} ignoreWater 
     * @returns {boolean}
     */

    static checkItem(x, y, s, sM, indx, ignoreWater) {
